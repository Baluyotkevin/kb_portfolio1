                ...
                <div key={id} className='lg:min-h-[32.5rem] sm:h-[41rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw]'>
                    <PinContainer title={title}>
                        <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden h-[30vh] sm:h-[40vh] mb-10">
                            ...
                            <img src={img} alt='Kevin Baluyot' className="z-10 absolute bottom-0 rounded-3xl" />
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-7 mb-3">
                            <div className="flex items-center">
                                {iconLists.map((icon, index) => (
                                    ...
                                    >
                                        <img src={icon} alt={icon} className="o-2" />
                                    </div>
                                ))}
                            </div>

                            <a href={link}  target="_blank" className='flex justify-center items-center'>
                            <p className='flex lg:text-xl md:text-xs text-sm text-red' >Check Live Site</p>
                                <FaLocationArrow className="ms-3" color="#CE5674" />
                            </a>
                        </div>
                    </PinContainer>
                </div>
